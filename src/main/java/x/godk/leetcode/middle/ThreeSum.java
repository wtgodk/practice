...
public class ThreeSum {
    ...
    public static void main(String[] args) {
        int[] a = {0, 0, 0, 0};
        List<List<Integer>> solution = solution3(a);
     ...
     * @date 2021/1/6 9:25
     */
    private static List<List<Integer>> solution3(int[] nums) {
        ...
        for (int i = 0; i < nums.length - 2; i++) {
            ...
            while (left < right) {
                if (nums[left] + nums[right] == -flag) {
                    ans.add(Arrays.asList(flag, nums[left++], nums[right--]));
                ...
                } else if (nums[left] + flag + nums[right] > 0) {
                    right--;
                } else {
                    left++;
                }
